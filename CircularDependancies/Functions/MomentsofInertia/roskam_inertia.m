function aircraft = roskam_inertia(aircraft)
...
%   inertia outputs are in slug-ft^2
    ...
    MTOW_lb = aircraft.weight.total;
    Wempty_lb = aircraft.weight.empty;
    b_ft = aircraft.wing.span;
    L_ft = aircraft.wing.l;
    g = 32.2; % ft/s^2
    ...
    aircraft.inertia.selection_score = scores(idx);
end