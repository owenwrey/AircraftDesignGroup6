...
f.thrust = 2*aircraft.engine.thrust; % [lb]

f.W.TOguess = aircraft.weight.total; % [lb]
f.W.fuelReq = aircraft.weight.fuel; % [lb]
...
f.cruise.speed.out.A2A = 800; % [KTAS] not yet implemented
f.cruise.distance.in.A2A = 700; % [nmi]
f.cruise.speed.in.A2A = 800; % not yet implemented
...
f.cruise.speed.out.STK = 800; % [KTAS] not yet implemented
f.cruise.distance.in.STK = 700; % [nmi]
f.cruise.speed.in.STK = 800; % not yet implemented
