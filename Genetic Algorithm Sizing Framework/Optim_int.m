...
nvars = 3;     % It should be equal to the number of design variables
...
IntCon =3;  % Why 3? Because the column number for discrete variable is 3 in the bounds. 
             % If there were more than one discrete design variables, you could have added IntCon = [3 4 5...] 
             % based on whichever columns are responsible for discrete design variables 
...
% 5xnvars.
populationSize = max(20, 10 * nvars);
...
[xPareto, fPareto, exitflag, output, population, scores] = ...
    gamultiobj(@objectiveFunction, nvars, [], [], [], [], lb, ub, [], IntCon, options);
