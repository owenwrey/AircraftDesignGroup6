...
10; % 9. descend
10; % 10. loiter
3; % 11. landing, taxi, shutdown (LTS)
];
npts_sum = sum(npts);
% Tbl = table();
...
Tbl.CD0(i) =  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)) ; % drag polar
...
Tbl.CD0(i) =  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar
Tbl.K1(i) = 0; % drag polar
Tbl.K2(i) = 0.05; % drag polar
Tbl.CDR(i) = 0; % drag polar
...
Tbl.CL(i) = (Tbl.WtFrac(i-1)*W_S)/(0.5*Tbl.rho(i)*(Tbl.KTAS(i)*kts2fps)^2); % lift coefficient
Tbl.CD0(i) =  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar 0.025; % drag polar
Tbl.K1(i) = 0; % drag polar
Tbl.K2(i) = 0.05; % drag polar
...
Tbl.CL(i) = (Tbl.WtFrac(i-1)*W_S)/(0.5*Tbl.rho(i)*(Tbl.KTAS(i)*kts2fps)^2); % lift coefficient
Tbl.CD0(i) =  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar 0.025; % drag polar
Tbl.K1(i) = 0; % drag polar
Tbl.K2(i) = 0.05; % drag polar
Tbl.CDR(i) = 0; % drag polar
Tbl.CD(i) = Tbl.CD0(i) + Tbl.K1(i)*Tbl.CL(i) + Tbl.K2(i)*Tbl.CL(i)^2 + Tbl.CDR(i); % drag coefficient
...
for  i = istart6:iend6
Tbl.Time(i) = Tbl.Time(istart6 - 1); % distance (NM)
Tbl.dTime(istart6) = 0; 
Tbl.dTime(i) = Tbl.Time(i) - Tbl.Time(i-1); % delta distance (NM)
...
Tbl.CL(i) = (Tbl.WtFrac(i-1)*W_S)/(0.5*Tbl.rho(i)*(Tbl.KTAS(i)*kts2fps)^2); % lift coefficient
Tbl.CD0(i) =  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar 0.045; % drag polar
Tbl.K1(i) = 0; % drag polar
Tbl.K2(i) = 0.05; % drag polar
Tbl.CDR(i) = 0; % drag polar
Tbl.CD(i) = Tbl.CD0(i) + Tbl.K1(i)*Tbl.CL(i) + Tbl.K2(i)*Tbl.CL(i)^2 + Tbl.CDR(i); % drag coefficient
...
Tbl.Alt(istart9:iend9) = linspace(Tbl.Alt(istart9 - 1),0,npts(9,:)); % altitude (ft)
...
Tbl.Time(istart10:iend10) = linspace((Tbl.Time(istart10-1)),(Tbl.Time(istart10-1)+20),npts(10,:)); % distance (NM)
Tbl.dTime(istart10) = 0; 
...
Tbl.CL(i) = (Tbl.WtFrac(i-1)*W_S)/(0.5*Tbl.rho(i)*(Tbl.KTAS(i)*kts2fps)^2); % lift coefficient
Tbl.CD0(i) =  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar  aircraft.aero.cd0(Tbl.Alt(i),Tbl.MACH(i)); % drag polar 0.023; % drag polar
Tbl.K1(i) = 0; % drag polar
...
Tbl.Time(istart11:iend11) = linspace((Tbl.Time(istart11-1)),(Tbl.Time(istart11-1)+ 3),npts(11,:)); % time (min)
...
% equations
Tbl.EnHt = Tbl.Alt + (Tbl.KTAS*NM2ft/60).^2/(2*32.17);
