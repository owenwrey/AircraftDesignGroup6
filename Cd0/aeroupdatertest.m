...
aircraft.wing.t_c  = 0.045;        % thickness ratio t/c 
aircraft.wing.x_c  = 0.30;         % x/c location of max thickness
aircraft.wing.sweep = 24;    % degrees  (F/A-18 style LE sweep)
...
aircraft.fuselage.l    = 50;       % ft fuselage length (board)
