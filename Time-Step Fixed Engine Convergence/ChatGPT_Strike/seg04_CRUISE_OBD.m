function Tbl = seg04_CRUISE_OBD(Tbl, istart, iend, p)
%SEG04_CRUISE_OBD Cruise outbound: 30k ft, 650 NM.

Tbl.Dist(istart:iend) = linspace(Tbl.Dist(istart-1), Tbl.Dist(istart-1)+p.cruiseOut_nm, (iend-istart+1));
