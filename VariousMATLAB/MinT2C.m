...
% level off sea level to 46,250 ft
...
[ALT_grid, KTAS_grid] = meshgrid(Alt, KTAS);
V_grid = KTAS_grid * kts2fps;

q_grid = 0.5 .* (rho') .* (V_grid.^2);

CL_grid = W0 ./ (q_grid .* S);
CD_grid = CD0 + K2 * CL_grid.^2;
...
% ============================================================
% === For each target energy height, pick best Ps state ===
% ============================================================
